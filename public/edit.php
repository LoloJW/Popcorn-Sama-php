...
session_start();
    ...
    if ( $_SERVER['REQUEST_METHOD'] === "POST" ) {
        ...
        if ( 
            ...
            // Puis arrêter l'exécution du script.
            header("Location: edit.php?film_id={$film['id_film']}");
            die();
        }
        ...
        updateFilm($ratingRounded, $film['id_film'], $_POST);
                        ...
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="comment" id="comment" class="form-control" rows="4"><?= isset($_SESSION['old']['comment']) && !empty($_SESSION['old']['comment']) 
                                    ? htmlspecialchars($_SESSION['old']['comment']) : htmlspecialchars($film['comment']); 
                            ...
                            <div>
                                <input formnovalidate type="submit" value="Modifier" class="w-100 btn btn-danger shadow">
                            </div>
                        </form>
                    </div>
                </div>
